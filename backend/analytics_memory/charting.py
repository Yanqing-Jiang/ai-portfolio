...
from analytics_shared.charting.planner import (
...
# Use shared function
_generate_descriptive_title = generate_descriptive_title


# Use shared function
_detect_primary_series = detect_primary_series


# Use shared function
_assign_series_axes = assign_series_axes


# Wrapper to convert shared function result to ChartPlanModel
def plan_chart_rule_based_local(data: List[Dict[str, Any]], query: str, intent_key: str = None) -> ChartPlanModel:
    """Wrapper for shared chart planning function that returns ChartPlanModel."""
    # Call shared function and convert result
    result = plan_chart_rule_based(data, query, intent_key)
...
plan_chart_rule_based = plan_chart_rule_based_local
