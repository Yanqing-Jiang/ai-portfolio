...
- single-agent: wraps each baseline step with `tool_call` start/end telemetry, durations, and SQL template metadata while leaving downstream events unchanged.
