  ...
  <VizFrame>
    <div className="flex items-center gap-8">
      ...
      <div className="flex flex-col gap-4">
        <motion.div animate={{ opacity: phase === 0 ? 1 : 0.2, borderColor: phase === 0 ? HOMER_THEME.accent : HOMER_THEME.divider }} className="px-6 py-2 border rounded font-mono text-sm flex items-center gap-2">
          Fast <Zap size={14} style={{ color: HOMER_THEME.accent }}/>
        </motion.div>
        <motion.div animate={{ opacity: phase === 1 ? 1 : 0.2, borderColor: phase === 1 ? '#ef4444' : HOMER_THEME.divider }} className="px-6 py-2 border rounded font-mono text-sm flex items-center gap-2">
          Primary <AlertCircle size={14} style={{ color: '#ef4444' }}/>
        </motion.div>
        <motion.div animate={{ opacity: phase === 2 ? 1 : 0.2, borderColor: phase === 2 ? HOMER_THEME.accent : HOMER_THEME.divider }} className="px-6 py-2 border rounded font-mono text-sm flex items-center gap-2">
...
const WebUiViz = ({ phase }: { phase: number }) => (
  <VizFrame>
    <div className="flex items-center gap-8 w-full max-w-sm px-8">
