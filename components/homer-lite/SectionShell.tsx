...
// Hero / ProofStrip / Why / Architecture / MemorySchema / MorningRoutineVideo /
// Metrics / Lessons / OssCard / CTA. Exists so individual section files stay
// content-only and inherit the page's scroll choreography.
//
