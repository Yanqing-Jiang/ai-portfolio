...
const LANE_BADGE_CLASS: Record<string, string> = {
  ...
  sql: 'bg-sky-500/25 text-sky-200 border border-sky-400/40',
  analyst: 'bg-emerald-500/25 text-emerald-200 border border-emerald-400/40',
  analysis: 'bg-emerald-500/25 text-emerald-200 border border-emerald-400/40',
  ...
  web: 'bg-indigo-500/25 text-indigo-200 border border-indigo-400/40',
