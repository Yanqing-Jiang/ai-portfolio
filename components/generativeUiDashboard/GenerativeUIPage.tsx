                ...
                <div className="relative z-10 flex flex-col min-h-[100dvh] overflow-hidden">
                                    ...
                                    {!dashboardId && (
                                        ...
                                        <div className="flex-1 flex flex-col items-center justify-center relative overflow-hidden py-8">
                                            ...
                                            >
                                                ...
                                                {/* Mobile-friendly quick-start prompt chips */}
                                                <motion.div
                                                    initial={{ y: 20, opacity: 0 }}
                                                    animate={{ y: 0, opacity: 1 }}
                                                    transition={{ delay: 0.35, duration: 0.6 }}
                                                    className="mb-16 flex flex-col items-center gap-3 px-2"
                                                >
                                                    ...
                                                    <div className="flex flex-wrap justify-center gap-2 sm:gap-3 max-w-3xl">
                                                        {SUGGESTIONS.map((s, i) => (
                                                            <motion.button
                                                                ...
                                                                transition={{ delay: 0.5 + i * 0.05, type: 'spring', stiffness: 240, damping: 22 }}
                                                                whileHover={{ y: -2, backgroundColor: 'rgba(244,63,94,0.10)', borderColor: 'rgba(244,63,94,0.55)' }}
                                                                whileTap={{ scale: 0.96 }}
                                                                onClick={() => {
                                                                    setQuestion(s.text);
                                                                    handleSubmit(s.text);
                                                                ...
                                                                disabled={isCreating}
                                                                className="flex items-start gap-2 sm:gap-3 rounded-xl px-3 sm:px-4 py-2 sm:py-3 text-left text-xs sm:text-sm text-slate-200 transition-colors disabled:cursor-not-allowed disabled:opacity-50 shadow-sm min-h-[44px] sm:min-h-[56px] w-[calc(50%-0.25rem)] sm:w-auto sm:max-w-[260px]"
                                                                style={{
                                                            ...
                                                            >
                                                                <span className="text-base sm:text-lg flex-shrink-0 opacity-80">{s.icon}</span>
                    ...
                    >
                        ...
                        >
                            ...
                            <SuggestionPopup
                                isVisible={showSuggestions && !question && !isMobile}
